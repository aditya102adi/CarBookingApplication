...
INSERT INTO driver (id, user_id, rating, is_Avaliable, current_location) VALUES
(2, 2, 4.7, true, ST_GeomFromText('POINT(88.3639 22.5726)', 4326)),
(3, 3, 4.8, true, ST_GeomFromText('POINT(88.3700 22.5800)', 4326)),
(4, 4, 4.6, true, ST_GeomFromText('POINT(88.3500 22.5600)', 4326)),
(5, 5, 4.9, true, ST_GeomFromText('POINT(88.4000 22.5700)', 4326)),
(6, 6, 4.3, true, ST_GeomFromText('POINT(88.3300 22.5500)', 4326)),
(7, 7, 4.4, true, ST_GeomFromText('POINT(88.4200 22.5900)', 4326)),
(8, 8, 4.5, true, ST_GeomFromText('POINT(88.3900 22.6000)', 4326)),
(9, 9, 4.6, true, ST_GeomFromText('POINT(88.3600 22.5800)', 4326)),
(10, 10, 4.7, true, ST_GeomFromText('POINT(88.4100 22.6100)', 4326)),
(11, 11, 4.8, true, ST_GeomFromText('POINT(88.3800 22.5600)', 4326)),
(12, 12, 4.2, true, ST_GeomFromText('POINT(88.3700 22.5900)', 4326)),
(13, 13, 4.1, true, ST_GeomFromText('POINT(88.3400 22.5700)', 4326)),
(14, 14, 4.0, true, ST_GeomFromText('POINT(88.3200 22.5800)', 4326)),
(15, 15, 4.5, true, ST_GeomFromText('POINT(88.3000 22.6000)', 4326)),
(16, 16, 4.3, true, ST_GeomFromText('POINT(88.3100 22.6200)', 4326)),
(17, 17, 4.6, true, ST_GeomFromText('POINT(88.3300 22.6300)', 4326)),
(18, 18, 4.4, true, ST_GeomFromText('POINT(88.2900 22.6400)', 4326)),
(19, 19, 4.7, true, ST_GeomFromText('POINT(88.2800 22.6500)', 4326)),
(20, 20, 4.8, true, ST_GeomFromText('POINT(88.2700 22.6600)', 4326)),
(21, 21, 4.5, true, ST_GeomFromText('POINT(88.3650 22.5750)', 4326)),
(22, 22, 4.7, true, ST_GeomFromText('POINT(88.3660 22.5770)', 4326)),
(23, 23, 4.8, true, ST_GeomFromText('POINT(88.3670 22.5790)', 4326)),
(24, 24, 4.6, true, ST_GeomFromText('POINT(88.3680 22.5810)', 4326)),
(25, 25, 4.9, true, ST_GeomFromText('POINT(88.3690 22.5830)', 4326)),
(26, 26, 4.3, true, ST_GeomFromText('POINT(88.3700 22.5850)', 4326)),
(27, 27, 4.4, true, ST_GeomFromText('POINT(88.3710 22.5870)', 4326)),
(28, 28, 4.5, true, ST_GeomFromText('POINT(88.3720 22.5890)', 4326)),
(29, 29, 4.6, true, ST_GeomFromText('POINT(88.3730 22.5910)', 4326)),
(30, 30, 4.7, true, ST_GeomFromText('POINT(88.3740 22.5930)', 4326)),
(31, 31, 4.8, true, ST_GeomFromText('POINT(88.3750 22.5950)', 4326)),
(32, 32, 4.2, true, ST_GeomFromText('POINT(88.3760 22.5970)', 4326)),
(33, 33, 4.1, true, ST_GeomFromText('POINT(88.3770 22.5990)', 4326)),
(34, 34, 4.0, true, ST_GeomFromText('POINT(88.3780 22.6010)', 4326)),
(35, 35, 4.5, true, ST_GeomFromText('POINT(88.3790 22.6030)', 4326)),
(36, 36, 4.3, true, ST_GeomFromText('POINT(88.3800 22.6050)', 4326)),
(37, 37, 4.6, true, ST_GeomFromText('POINT(88.3810 22.6070)', 4326)),
(38, 38, 4.4, true, ST_GeomFromText('POINT(88.3820 22.6090)', 4326)),
(39, 39, 4.7, true, ST_GeomFromText('POINT(88.3830 22.6110)', 4326)),
(40, 40, 4.8, true, ST_GeomFromText('POINT(88.3840 22.6130)', 4326));
